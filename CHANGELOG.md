...
- 35-tool MCP wrapper around the PowerShell/Python control layer, with guarded writes and handoff-oriented analysis tools.

### Changed

- Public README and usage docs now describe the current 35-tool MCP / 46-command CLI surface consistently.
