...
| 7 | Engineering_lite | Present/guarded. | `engineering-lite` reports BOM quantity rollups, drawing-BOM CSV rows, material blockers, hostless standard-part blockers, and DFM/DFA warnings from inspect evidence. |
