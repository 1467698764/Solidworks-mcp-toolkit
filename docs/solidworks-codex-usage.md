...
- 牛头刨床：`tools/solidworks_codex/live_fixture/shaper_machine_v5/bullhead_shaper_complete.SLDASM`，严格检查零件数、组件数、主要功能组件 Transform2/origin 位置回读、mate 语义和参与组件、配合创建时的 2 实体选择证据、质量、0 干涉、inspect/model-understanding 证据、文件锁。
