...
| `assembly-review-pipeline` | `solidworks_assembly_review_pipeline` | `analysis` | `read_only` | `False` | `report` |
...
| `mate-group-execute` | `solidworks_mate_group_execute` | `guarded_edit` | `guarded_write` | `True` | `macro_manifest` |
...
| `part-geometry-validate` | `solidworks_part_geometry_validate` | `verify_export` | `verification_or_export` | `False` | `report, contract` |
