...
GROUP_RULES = {
    ...
    "analysis": ["issue", "design_review", "change_plan", "workflow_plan", "report_search", "report_context", "model_understand", "engineering_lite", "diagnose", "mate_selection_check"],
    "handoff": ["worklog", "handoff", "ai_capability_map"],
