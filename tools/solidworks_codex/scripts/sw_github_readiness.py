...
def main() -> None:
    ...
    checks = {
        "root_readme": check_contains("README.md", ["practical SolidWorks MCP", "50 MCP tools", "model-understand", "report-context", "handoff-bundle", "tool-catalog", "audit"]),
        ...
        "release_checklist": check_contains("docs/github-release-checklist.md", ["50 MCP tools", "model-understand", "handoff-bundle", "Do not commit", "audit"]),
