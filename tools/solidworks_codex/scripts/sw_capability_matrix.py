...
WORKFLOW_BY_CLI = {
    ...
    "metadata-execute": "guarded_edit",
    "start-metadata-execute": "guarded_edit",
    "mate-group-execute": "guarded_edit",
    "mate-intent-execute": "guarded_edit",
    "motion-sweep-lite": "guarded_edit",
...
MCP_TO_CLI = {
    ...
    "solidworks_mate_intent_execute": "mate-intent-execute",
    ...
    "solidworks_visual_capture": "visual-capture",
    "solidworks_visual_validate": "visual-validate",
    ...
    "solidworks_motion_sweep_lite": "motion-sweep-lite",
