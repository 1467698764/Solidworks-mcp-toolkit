...
- `mcp/server.cjs` exposes the 45 MCP tools and delegates to `swctl.ps1`, including MCP entries such as `solidworks_tool_catalog`, `solidworks_handoff_bundle`, and `solidworks_worklog`.
